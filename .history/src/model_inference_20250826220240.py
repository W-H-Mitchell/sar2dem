...
def main():
    ...
    parser.add_argument('--sar_path', default='data/testing/AFGHANISTAN_0/AFGHANISTAN_y0x24064_DESCENDING.tif',
                        help='Path to input SAR image')
    parser.add_argument('--dem_path', default='data/testing/AFGHANISTAN_0/AFGHANISTAN_y0x24064_DESCENDING.tif',
