"""
Simplified DEM Mosaic Prediction with Calibration
Generates regional DEMs from SAR using trained models with calibration options:
1. Raw model output (no calibration)
2. Coarse DEM calibration (statistical matching)
3. Point calibration using IDW (if control points provided)
"""
...
from src.training.utils.setup_midas import loadModelFabric


class DEMMosaicPredictor:
    """Simplified DEM mosaic prediction with calibration options."""
    ...
    def predict_dem(self, 
        ...
        Args:
            ...
            calibration_method: 'none', 'coarse_dem', or 'idw'
        ...
        # Apply calibration
        if calibration_method == "coarse_dem" and coarse_dem_path:
...
def main():
    ...
    parser.add_argument("sar_path", help="Path to SAR image")
    parser.add_argument("model_path", help="Path to trained model")
    parser.add_argument("output_path", help="Path for output DEM")
    parser.add_argument("--calibration", choices=["none", "coarse_dem", "idw"], 
