...
def main():
    ...
    parser.add_argument("--coarse_dem", default=".//Users/williammitchell/Documents/projects/sar2dem/data/regional_dem/clipped_ground_truth.tif",
                        help="Path to coarse DEM for calibration")
    parser.add_argument("--reference_dem", default=None,
