...
from model_inference import load_dpt_model, load_im2height_model
...
def main():
    ...
    parser.add_argument("--coarse_dem", default="./data/regional_dem/clipped_coarse_dem_5km.tif",
                        help="Path to coarse DEM for calibration")
    parser.add_argument("--tile_size", type=int, default=384, 
                        help="Tile size for processing")
    parser.add_argument("--overlap", type=int, default=0.25, 
                        help="Tile overlap (0-1)")
