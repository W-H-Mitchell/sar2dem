...
def main():
    ...
    parser.add_argument('--im2height-model', type=str, default=None,
                        help='Path to Im2Height weights (optional)')
    parser.add_argument('--dem-min', type=float, default=None,
                        help='Override minimum DEM value for denormalization')
    parser.add_argument('--dem-max', type=float, default=None,
                        help='Override maximum DEM value for denormalization')
    ...
    # Override DEM min/max if provided
    if args.dem_min is not None:
        config.DEM_MIN_FALLBACK = args.dem_min
    if args.dem_max is not None:
        config.DEM_MAX_FALLBACK = args.dem_max
